let impressionsArr = [
  800, 1200, 400, 200, 1800, 400, 200, 100, 400, 2000, 400, 600, 400, 400, 800,
  200, 200, 50, 400, 200, 100, 800, 200, 100, 100, 400, 100, 50, 100, 200, 200,
  400, 200, 400, 400, 160, 160, 300, 150, 400, 400, 400, 200, 100, 400, 50, 400,
  400, 100, 800, 400, 100, 25, 800, 2000, 50, 50, 400, 100, 100, 50, 25, 200,
  200, 600, 100, 400, 400, 50, 100, 150, 300, 400, 800, 50,
];

let colorsArr = [
  4, 3, 2, 2, 3, 2, 2, 2, 2, 2, 1, 3, 2, 2, 4, 1, 1, 1, 1, 1, 1, 2, 1, 1, 1, 2,
  1, 1, 2, 1, 2, 2, 2, 1, 4, 4, 4, 4, 3, 1, 1, 1, 1, 2, 2, 2, 2, 2, 2, 4, 4, 2,
  1, 2, 2, 2, 2, 2, 2, 2, 1, 1, 2, 2, 3, 2, 2, 4, 2, 2, 3, 3, 2, 4, 1,
];

let sidesArr = [
  2, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 1, 2, 2, 2, 1, 2,
  1, 1, 2, 2, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
  1, 2, 2, 1, 1, 2, 2, 2, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1,
];

let objsArr = [
  { impressions: 800, colors: 4, sides: 2 },
  { impressions: 1200, colors: 3, sides: 2 },
  { impressions: 400, colors: 2, sides: 2 },
  { impressions: 200, colors: 2, sides: 2 },
  { impressions: 1800, colors: 3, sides: 2 },
  { impressions: 400, colors: 2, sides: 2 },
  { impressions: 200, colors: 2, sides: 2 },
  { impressions: 100, colors: 2, sides: 1 },
  { impressions: 400, colors: 2, sides: 2 },
  { impressions: 2000, colors: 2, sides: 2 },
  { impressions: 400, colors: 1, sides: 2 },
  { impressions: 600, colors: 3, sides: 2 },
  { impressions: 400, colors: 2, sides: 2 },
  { impressions: 400, colors: 2, sides: 2 },
  { impressions: 800, colors: 4, sides: 2 },
  { impressions: 200, colors: 1, sides: 1 },
  ...
  { impressions: 160, colors: 4, sides: 2 },
  { impressions: 160, colors: 4, sides: 2 },
  { impressions: 300, colors: 4, sides: 2 },
  { impressions: 150, colors: 3, sides: 2 },
  { impressions: 400, colors: 1, sides: 2 },
  { impressions: 400, colors: 1, sides: 2 },
  { impressions: 400, colors: 1, sides: 2 },
  { impressions: 200, colors: 1, sides: 2 },
  ...
  { impressions: 100, colors: 2, sides: 2 },
  { impressions: 150, colors: 3, sides: 2 },
  { impressions: 300, colors: 3, sides: 2 },
  { impressions: 400, colors: 2, sides: 2 },
  { impressions: 800, colors: 4, sides: 2 },
  { impressions: 50, colors: 1, sides: 1 },
];
