let impressionsArr = [
  400, 800, 150, 800, 1200, 400, 200, 1800, 400, 200, 400, 100, 400, 100, 200,
  38, 2000, 400, 200, 200, 200, 600, 400, 100, 50, 400, 400, 200, 400, 800, 400,
  800, 200, 600, 50, 200, 100, 1000, 400, 160, 160, 300, 400,
];

let colorsArr = [
  2, 4, 3, 4, 3, 2, 2, 3, 2, 2, 2, 2, 2, 1, 1, 1, 2, 1, 1, 2, 2, 2, 2, 1, 2, 2,
  2, 4, 4, 4, 2, 4, 4, 4, 1, 2, 1, 1, 4, 4, 4, 4, 1,
];

let sidesArr = [
  2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
...
let objsArr = [
  ...
  { impressions: 38, colors: 1, sides: 1 },
  { impressions: 200, colors: 1, sides: 2 },
  ...
  { impressions: 1000, colors: 1, sides: 1 },
